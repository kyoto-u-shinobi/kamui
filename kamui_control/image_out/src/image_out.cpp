...
cv_bridge::CvImagePtr thermal_cv_ptr(new cv_bridge::CvImage);	// 熱画像
...
//=============================================
    ...
    : it_(nh_)
  {
	...
	thermal_image_sub_ = it_.subscribe("thermal_image_out", 1,&Imagemsg2Imagefile::thermal_imageCb, this);
	camera_image_sub_ = it_.subscribe("image_raw", 1,&Imagemsg2Imagefile::camera_imageCb, this);
